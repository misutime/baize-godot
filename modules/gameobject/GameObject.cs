...
public AuthoringObjectId AuthoringId { get; internal set; }
	...
	/// <summary>创建该对象时的世界 Tick（创建时由世界赋值；内部）。</summary>
	internal ulong CreatedAtTickIndex { get; set; }

	/// <summary>创建该对象时的世界 Tick（O2 回滚本帧创建用；公开以便游戏层引用）。</summary>
	public ulong SpawnTickIndex => CreatedAtTickIndex;
